  ...
  background: white;
    ...
    <body class="stretched">
        ...
        <div id="wrapper" class="clearfix">
                    ...
                    <div class="container-fluid clearfix" style="height: 60px">
                        ...
                        <div class="col-lg-8 col-md-8 col-lg-offset-1">
                            <div class="differnet-text text-center" style="margin-top: 18px">
                                <a href="#" style="font-size:20px;font-weight:bold">HEALTH & BEAUTY</a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="swiper-container swiper-parent">
                            <div class="swiper-wrapper" style="height: 497px">
                                <div class="swiper-slide dark" style="background-image: url('../theme/images/slider/swiper/healthandbeauty.jpg');color: black;">
                                    <div style="padding: 10px 60px;">
                                    <div>Beauty</div>
                                    <div style="padding:140px 0px 200px 0px;">
                                        <p style="font-family: Bloomfield, 'Helvetica Neue', Helvetica, Arial, sans-serif;font-weight: 700;font-size: 48px;letter-spacing: -2.3px;margin-bottom: 5px;line-height: 52px">New season,<br>new scents</p>                              
                                        <p style="margin-bottom: 5px;width: 340px;font-size: 16px;">Discover fresh arrivals and<br>fragrance must-haves.</p>
                                        <button class="btn-primary btn-md" style="width: 200px;font-size: 20px;margin-top:16px;padding: 6px;height: 48px;background-color: rgb(49, 97, 196);font-weight: 700;text-decoration-color: #fff;border-width: inherit">Shop Fragrance</button>
                                    </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- <div class="section" style="margin-top: 0px;padding: 0px;background: #fff; margin-bottom: 0px">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 col-lg-offset-1 col-md-offset-1 col-sm-offset-1 col-xs-offset-1">
                                    <a href="#">
                                        <img src="../theme/images/brand/health01.jpg" class="center-block" alt="">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <p class="text-center" style="color: rgb(51, 51, 51);letter-spacing: -2px;font-size: 36px; font-weight:700;margin-top: 16px; margin-bottom: 12px">Spring skincare</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <p class="text-center" style="color: rgb(51, 51, 51);font-size: 16px;height: 28px">Try a new skincare routine for the best season.</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <button class="btn-primary btn-md center-block" style="padding: 6px;height: 40px;background-color: rgb(134, 103, 101);font-size: 14px;margin-bottom: 12px;font-weight: 700;text-decoration-color: #fff;border-width: inherit">Shop Spring Skincare</button>              
                                            </div>
                                        </div>
                                    </a> 
                                </div>
                                <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5">
                                    <a href="#">
                                        <img src="../theme/images/brand/health02.jpg" class="center-block" alt="">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <p class="text-center" style="color: rgb(51, 51, 51);letter-spacing: -2px;font-size: 36px; font-weight:700;margin-top: 16px; margin-bottom: 12px">Treat your hair</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <p class="text-center" style="color: rgb(51, 51, 51);font-size: 16px;height: 28px">Good hair days should be every day.</p>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                <button class="btn-primary btn-md center-block" style="padding: 6px;height: 40px;background-color: rgb(134, 103, 101);font-size: 14px; font-weight: 700;margin-bottom: 12px;text-decoration-color: #fff;border-top-color: rgb(134, 103, 101);border-width: inherit">Shop Spring Hair</button>              
                                            </div>
                                        </div>
                                    </a> 
                                </div>
         ...
         <div class="category-list" style="margin-left:14%">
                   
         <?php 
         
             $subc="select * from sub_categories where category_id= 2";
         ...
         ?>
            ...
            <section id="content">
                <div class="content-wrap" style="padding:0px 0px 40px 0px;">
                    <div class="container clearfix">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <h2 style="font-size: 24px; font-weight: 700;margin-bottom: 0px">Health and Beauty Products</h2>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="section" style="padding: 0px;background: #fff;margin-top: 0px; margin-bottom: 0px">
                <div class="container clearfix">
                    <div class="row topmargin-sm" style="margin-top: 40px !important; margin-bottom: 50px">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <section style="height: 320px;" class="swiper_wrapper clearfix">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="swiper-container swiper-parent">
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide dark" style="background-image: url('../theme/images/brand/health06.jpg'); height: 320px;color: black;">
                                                        <div style="padding: 10px 60px;">
                                                            <div style="padding:58px 0px 200px 0px;">
                                                                ...
                                                                <p style="margin-bottom: 5px;width: 340px;font-size: 16px;">Curls, waves, or straight -<br>make your hair your kind of great.</p>                                            
                                                                <div class="row">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <button class="btn-primary btn-md" style="width: 200px;font-size: 20px;margin-top:16px;padding: 6px;height: 40px;background-color: rgb(134, 103, 101);font-weight: 700;text-decoration-color: #fff;border-width: inherit">Shop Hair Tools</button>              
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
