                    ...
                    <div class="container-fluid clearfix" style="height: 60px">
                        ...
                        <div class="col-lg-8 col-md-8 col-lg-offset-1">
                            <div class="differnet-text text-center" style="margin-top: 18px">
                                <a href="#" style="font-size:20px;font-weight:bold">GROCERIES</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="swiper-container swiper-parent">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide dark" style="background-image: url('../theme/images/slider/swiper/groceries_background.jpg');color: black;">
                                    <div style="padding: 10px 60px;">
                                    <div>Grocery & Household</div>
                                    <div style="padding:140px 0px 200px 0px;">
                                        ...
                                        <p style="margin-bottom: 5px;width: 340px;font-size: 16px;">Find your favorite everyday essentials here.</p>
                                    </div>
                                    </div>
<!--                                    <div class='row' style="background:white;opacity: 0.8;height: 62px;margin: 0;padding: 17px 0px 18px 0px; text-align: center;">
                                ...
                                <div class="row topmargin-sm" style="margin-top: 12px !important">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                                <a href="#">
                                                    <img src="../theme/images/brand/groc01.jpg" class="center-block" alt="" style="height: 130px">
                                                </a>
                                            </div>
                                            <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                                <a href="#">
                                                    <img src="../theme/images/brand/groc02.jpg" class="center-block" alt="" style="height: 130px">
                                                </a>
                                            </div>
                                            <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                                <a href="#">
                                                    <img src="../theme/images/brand/groc03.jpg" class="center-block" alt="" style="height: 130px">
                                                </a>
                                            </div>
                                            <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                                <a href="#">
                                                    <img src="../theme/images/brand/groc04.jpg" class="center-block" alt="" style="height: 130px">
                                                </a>
                                            </div>
                                            <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                                <a href="#">
                                                    <img src="../theme/images/brand/groc05.jpg" class="center-block" alt="" style="height: 130px">
                                                </a>
                                            </div>
                                        </div>
                                    </div><br/>
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                                <a href="#">
                                                    <h5 class="text-center" style="font-weight: normal;color: black">Puffed Rice</h5>
                                                </a>
                                            </div>
                                            <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                                <a href="#">
                                                    <h5 class="text-center" style="font-weight: normal;color: black">Shopping Grocery Bag </h5>
                                                </a>
                                            </div>
                                            <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                                <a href="#">
                                                    <h5 class="text-center" style="font-weight: normal;color: black">Boyds Bears</h5>
                                                </a>
                                            </div>
                                            <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                                <a href="#">
                                                    <h5 class="text-center" style="font-weight: normal;color: black">Frito-Lay Classic</h5>
                                                </a>
                                            </div>
                                            <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                                <a href="#">
                                                    <h5 class="text-center" style="font-weight: normal;color: black">Grocery Food Store </h5>
                                                </a>
                                            </div>
                                        </div>
                                    </div><br/>
                    ...
                    <div class="row topmargin-sm" style="margin-top: 12px !important">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                    <a href="#">
                                        <img src="../theme/images/brand/groc06.jpg" class="center-block" alt="" style="height: 130px">
                                    </a>
                                </div>
                                <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                    <a href="#">
                                        <img src="../theme/images/brand/groc07.jpg" class="center-block" alt="" style="height: 130px">
                                    </a>
                                </div>
                                <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                    <a href="#">
                                        <img src="../theme/images/brand/groc08.jpg" class="center-block" alt="" style="height: 130px">
                                    </a>
                                </div>
                                <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                    <a href="#">
                                        <img src="../theme/images/brand/groc09.jpg" class="center-block" alt="" style="height: 130px">
                                    </a>
                                </div>
                                <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                    <a href="#">
                                        <img src="../theme/images/brand/groc10.jpg" class="center-block" alt="" style="height: 130px">
                                    </a>
                                </div>
                            </div>
                        </div><br/>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                    <a href="#">
                                        <h5 class="text-center" style="font-weight: normal;color: black">Pantry</h5>
                                    </a>
                                </div>
                                <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                    <a href="#">
                                        <h5 class="text-center" style="font-weight: normal;color: black">Household</h5>
                                    </a>
                                </div>
                                <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                    <a href="#">
                                        <h5 class="text-center" style="font-weight: normal;color: black">Drugstore</h5>
                                    </a>
                                </div>
                                <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                    <a href="#">
                                        <h5 class="text-center" style="font-weight: normal;color: black">Baby Essentials</h5>
                                    </a>
                                </div>
                                <div class="col-lg-15 col-md-15 col-sm-15 col-xs-15">
                                    <a href="#">
                                        <h5 class="text-center" style="font-weight: normal;color: black">Pet Essentials</h5>
                                    </a>
                                </div>
                            </div>
                        </div><br/>
         ...
         <div class="category-list" style="margin-left:35%">
                   
         <?php 
         
             $subc="select * from sub_categories where category_id= 4";
            ...
            <section id="content">
                <div class="content-wrap" style="padding:0px 0px 40px 0px; margin-top: 40px">
                    <div class="container clearfix">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <h2 style="font-size: 24px; font-weight: 700;margin-bottom: 0px">Groceries</h2>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <p style="font-size: 16px; font-weight: 400; color: rgb(51, 51, 51)"> </p>
                            </div>
                            <!-- <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <a href="#">
